...
Feature: Change Booking Module
  ...
  Scenario Outline: Modify the Created Order Id - Book hotel by  (UPI ID) with special request and without GST
    ...
    Examples: 
      ...
      | glittermurali@gmail.com | PassHack1! | Andhra Pradesh | Tirupati | Standard  | 15 July 2025  | 16 July 2025   | 1-One      | 2-Two        |            1 | Mr.               | Java       | Python    | 1234567890 | 123@123.com | Extra condition | UPI    | 25 July 2025 |
